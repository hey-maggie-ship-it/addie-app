...
export default function Ankora() {
  ...
  const finishOnboarding = () => {
    ...
    // Track how people actually answer so we can see if the style split is skewed.
    posthog.capture("onboarding_completed", { style: p.style || "skipped", pattern: p.pattern || "skipped", has_context: !!p.context });
